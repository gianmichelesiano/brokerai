    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">Carica le Polizze</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">Matrice Coperture</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">Confronta</h3>
              <p className="text-gray-600 text-sm">
      ...
      <section className="py-20 px-4 bg-slate-800">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Pronto a Rivoluzionare la Tua Analisi Assicurativa?</h2>
